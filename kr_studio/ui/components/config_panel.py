...
class ConfigPanel(ctk.CTkScrollableFrame):
    ...
    def _build_widgets(self):
        ...
        # Header
        header = ctk.CTkFrame(
            self, fg_color=COLORS["header_bg"], height=42, corner_radius=0
        )
        ...
        # Botón OBS
        self.main_window.obs_btn = ctk.CTkButton(
            self,
            text="📺 Conectar OBS",
        ...
        ctk.CTkButton(
            toolbar,
            text="💾 Guardar",
            command=self.main_window.save_project,
            font=("JetBrains Mono", 10, "bold"),
            fg_color="#1a1b2e",
            hover_color="#252640",
            border_width=1,
        ...
        ctk.CTkButton(
            toolbar,
            text="📂 Cargar",
            command=self.main_window.load_project,
            font=("JetBrains Mono", 10, "bold"),
            fg_color="#1a1b2e",
            hover_color="#252640",
            border_width=1,
        ...
        self.main_window.project_name_label = ctk.CTkLabel(
            toolbar,
            text="Sin título",
    ...
    def _build_sliders(self, parent):
        ...
        slider = ctk.CTkSlider(
            ...
            to=200,
            number_of_steps=15,
            command=self.main_window.on_speed_change,
            width=140,
        ...
        self.main_window.speed_label = ctk.CTkLabel(
            speed_row,
            text="70%",
            font=("JetBrains Mono", 10, "bold"),
        ...
        dur_slider = ctk.CTkSlider(
            ...
            to=30,
            number_of_steps=29,
            command=self.main_window.on_duration_change,
            width=140,
            fg_color=COLORS["border"],
        ...
        self.main_window.duration_label = ctk.CTkLabel(
            dur_row,
            text="5 min",
            font=("JetBrains Mono", 10, "bold"),
            text_color="#FF8F00",
    ...
    def _build_content_selector(self, parent):
        ...
        self.main_window.content_combo = ctk.CTkOptionMenu(
            content_row,
    ...
    def _build_action_buttons(self, parent):
        ...
        ctk.CTkButton(
            btn_row,
            text="🔊 TTS",
            command=self.main_window.generate_audios,
        ...
        ctk.CTkButton(
            btn_row,
            text="🎬 Lanzar",
            command=self.main_window.launch_konsole,
        ...
        ctk.CTkButton(
            btn_row,
            text="🚀 DUAL AI",
            command=lambda: handler.launch_director(DirectorMode.DUAL_AI),
            fg_color="#7B1FA2",
            hover_color="#6A1B9A",
            text_color="#ffffff",
            font=("JetBrains Mono", 11, "bold"),
        ...
        ctk.CTkButton(
            btn_row,
            text="🔴 Grabar",
            command=self.main_window.launch_and_record,
            fg_color="#D32F2F",
            hover_color="#B71C1C",
            text_color="#ffffff",
            font=("JetBrains Mono", 11, "bold"),
        ...
        self.main_window.btn_stop = ctk.CTkButton(
            btn_row,
            text="⏹ Detener",
            command=handler.stop_director,
            fg_color="#424242",
            hover_color="#616161",
            text_color="#ffffff",
            font=("JetBrains Mono", 11, "bold"),
        ...
        ctk.CTkButton(
            parent,
            text="⚡ SOLO TERM",
            command=lambda: handler.launch_director(DirectorMode.SOLO_TERM),
            fg_color="#E65100",
            hover_color="#BF360C",
            text_color="#ffffff",
            font=("JetBrains Mono", 11, "bold"),
